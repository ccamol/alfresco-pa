...
<link href="${page.url.context}/arauco/js/jquery-ui.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="${page.url.context}/arauco/ajax/tendering/offerAnalisysApplicant.js"></script>
...
<div id="bd">
	<div id="column1">
		<@region id="offerAnalysisDocument" scope="page"/>
		</div>
		
		<div id="column2">
		<@region id="offerAnalysisConsulting" scope="page"/>
		</div>
</div>
</@>
</@>
