...
<!--<script type="text/javascript" src="${page.url.context}/arauco/ajax/management/management.js" charset="utf-8"></script> -->
<script type="text/javascript" src="${page.url.context}/arauco/ajax/projectManagement/projectManagement.js" charset="utf-8"></script>
<script type="text/javascript" src="${page.url.context}/arauco/ajax/projectManagement/checklist.js" charset="utf-8"></script>
<!--<script type="text/javascript" src="${page.url.context}/arauco/ajax/management/uploadDocument.js" charset="utf-8"></script>-->
...
<div class="row clearfix">
	...
	<div class="row clearfix">
		...
		<@region id="expiration" scope="page"/>
		...
		<div class="col-md-6 column" id="containerDocument">
			...
			<@region id="mallDocument" scope="page"/>
	...
	<div class="row clearfix">
		...
		<@region id="checkStage" scope="page"/>
