	...
	<script type="text/javascript" src="${page.url.context}/arauco/ajax/management/management.js" charset="utf-8"></script>
	 ...
	 <script type="text/javascript" src="${page.url.context}/arauco/js/jquery.contextmenu.js" charset="utf-8"></script>
	   <script type="text/javascript" src="${page.url.context}/arauco/js/jquery.tablesorter.js" charset="utf-8"></script>
	   	 <script type="text/javascript" src="${page.url.context}/arauco/ajax/tendering/thirdPartyModule/thirdPartyModule.js" charset="utf-8"></script>
...
<div class="container col-md-12 column">
	<div class="row clearfix">
		...
		<div class="col-md-10 column"><@region id="projectModule" scope="page"/></div>
		<div class="col-md-1 column">
		</div>
	</div>
    <div class="row clearfix">
		...
		<div class="col-md-10 column"><@region id="associatedDocument" scope="page"/></div>
		<div class="col-md-1 column">
		</div>
	</div>	
</div>
