		...
		<div class="modal-body">
			...
			<br>
				...
				<table >
				    ...
				    <tr>
				   	   <td  width=65><input type="image" src="${image}"  onclick="downloadDocumentFromPopup('/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${uuid}/${documentName}?a=true');"   name="doc-download"   value="/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${uuid}/${documentName}?a=true"></td><td>${name_file}<br></td>
					</tr>	 
					...
					<#list downloables as d>
					    	...
					    	<tr>
				   	 			  <td  width=65><img src="${image}" onclick="downloadDocumentFromPopup('/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true');" name="doc-download"  value="/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true"></td><td>${name_file}<br></td>
							</tr>	 
