	...
	$.contextMenu = {
			...
			show: function(t,e) {
				...
				if (cmenu.beforeShow()!==false) {
					...
					$c.css( {top:y+"px", left:pos.x+"px", position:"absolute",zIndex:9999} )[cmenu.showTransition](cmenu.showSpeed,((cmenu.showCallback)?function(){cmenu.showCallback.call(cmenu);}:null));
					cmenu.shown=true;
