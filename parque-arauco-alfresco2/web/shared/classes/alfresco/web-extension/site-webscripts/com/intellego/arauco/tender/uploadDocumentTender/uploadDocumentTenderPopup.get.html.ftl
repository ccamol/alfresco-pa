<head>
<script type="text/javascript" src="/share/arauco/ajax/tender/uploadTender.js" charset="utf-8"></script>
</head>
...
<div class="col-md-12 column">
	<br/>
	<div class="col-md-12 column">
		<div class="subtitle-modal">Cargar documentos <button class="btn btn-success" id="btnUpload" onclick="uploadMultiple('${nodeType}' ,'${projectId}')">Subir Documento</button></div>			
	</div>
