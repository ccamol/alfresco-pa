				...
				<table >
					...
					<td  width=130 id ="${type_extension}">
				       <#if (("${type_extension}"=="xls")||("${type_extension}"=="xlsx") || ("${type_extension}"=="doc") || ("${type_extension}"=="docx")
				   	   ...
				   	   <img src="${image}"  onclick="downloadDocumentFromPopup('/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${uuid}/${documentName}?a=true');"   name="doc-download"   value="/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${uuid}/${documentName}?a=true"></td><td>${name_file}<br></td>
					</tr>	 
					...
					<#list downloables as d>
					    	...
					    	<tr>
			   	 			...
			   	 			<#if (("${type_extension}"=="xls")||("${type_extension}"=="xlsx") || ("${type_extension}"=="doc") || ("${type_extension}"=="docx")
				   	 			  ...
				   	 			  <img src="${image}"  onclick="downloadDocumentFromPopup('/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true');" name="doc-download"  value="/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true">
