...
<link href="${page.url.context}/arauco/js/jquery-ui.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="${page.url.context}/arauco/ajax/tendering/awardEvaluationApplicantAcces.js"></script>
</@>
<@templateBody>
<@markup id="alf-hd">
<div id="alf-hd">
...
<div id="bd">
		<div id="column1">
		<@region id="awardEvaluationRequestedDocument" scope="page"/>
		</div>
		
		<div id="column2">
		<@region id="awardEvaluationSharedDocument" scope="page"/>
		</div>
		
		<div id="column3">
		<@region id="awardEvaluationConsult" scope="page"/>
		</div>
