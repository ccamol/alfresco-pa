...
<link href="${page.url.context}/arauco/js/jquery-ui.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="${page.url.context}/arauco/js/jquery-ui.min.js" charset="utf-8"></script>
		<script type="text/javascript" src="${page.url.context}/arauco/ajax/moduleContractor/moduleContractor.js" charset="utf-8"></script>
...
<div class="container">
	...
	<@region id="mallProjectContractor" scope="page"/>
	
	<@region id="sharedDocument" scope="page"/>
	
	<@region id="requestedDocument" scope="page"/>
