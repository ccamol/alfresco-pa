...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <script type="text/javascript" src="${page.url.context}/arauco/ajax/mallSelection/mallSelection.js" charset="utf-8"></script>
    <script type="text/javascript" src="${page.url.context}/arauco/ajax/searchDocument/searchDocument.js" charset="utf-8"></script>
    <script type="text/javascript" src="${page.url.context}/arauco/ajax/editMallImage/editMallImage.js" charset="utf-8"></script>
...
<div class="container">
	<div class="row clearfix">
		...
		<div class="col-md-6 column"><@region id="mallSelection" scope="page"/>
		</div>
		<div class="col-md-3 column">
		</div>
	</div>
    <div class="row clearfix">
		...
		<div class="col-md-6 column"><@region id="searchDocumentEngineering" scope="page"/>
		</div>
		<div class="col-md-3 column">
		</div>
	</div>	
