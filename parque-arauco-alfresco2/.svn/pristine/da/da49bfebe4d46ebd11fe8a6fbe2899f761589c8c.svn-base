...
<div class="row clearfix">
	...
	<div class="modal-body">
		<div class="row clearfix scrollUpdate">
			...
			<div class="col-md-12 column">
				<div class="col-md-4 column">
							...
							<#assign image><@formatImage extension=type_extension1/></#assign>	
					    	<tr>
				   	 			  <td  width=65><img src="${image}"  onclick="downloadDocumentFromPopup('/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true');" name="doc-download"  value="/share/proxy/alfresco/api/node/content/workspace/SpacesStore/${d.uuid}/${d.name}?a=true"></td><td>${document.docinfo.name}<br></td>
							</tr>	 
				</div>
				<div>
					<table id="uploadDocumentContainer_${d.uuid}" class="col-md-12 column upload-document">
						<tr>						
							<td id="searchContainer" class="btnSearchContainer">
								<input type="file" name="file" id="fileUpdate_${d.uuid}">
							</td>				
						</tr>
					</table>
				</div>
			...
			<div class="col-md-12 column" style="background-color: lightgrey">
				<div class="col-md-4 column">
							<label style="color: green;padding-top: 7px;">A&ntildeadir nuevo contenido</label>	 
				</div>
				<div>
					<table id="newDocumentTable" class="col-md-12 column upload-document">
						<tr>						
							<td id="searchContainer" class="btnSearchContainer">
								<input type="file" name="file" id="newDocumentFile">
							</td>				
						</tr>
					</table>
				</div>
 	...
 	<div class="modal-footerpopup">	
      <input type="button" id="updateDocument" onclick="uploadUpdateContent()" class="btn btn-success" value="Actualizar contenido" />
    </div>
</div>
