...
<link href="${page.url.context}/arauco/js/jquery-ui.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="${page.url.context}/arauco/ajax/tendering/offerDeliveryApplicant.js"></script>
...
<div id="bd">
		<div id="column1">
		<@region id="offerDeliveryDocument" scope="page"/>
		</div>
		
		<div id="column2">
		<@region id="getRequestedDocumentOffer" scope="page"/>
		</div>
		
		<div id="column3">
		<@region id="getOfferConsulting" scope="page"/>
		</div>
</div>
</@>
</@>
