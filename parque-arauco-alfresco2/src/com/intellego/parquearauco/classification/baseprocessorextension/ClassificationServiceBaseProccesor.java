...
public class ClassificationServiceBaseProccesor extends BaseProcessorExtension{
	...
	public Response<Classification> copyClassification(String nodeUuidClassification, String nodeUuidNewParent){
		System.out.println("*** [copyClassification de ClassificationServiceBaseProccesor] ***");
		System.out.println("//		ClassificationService classificationService = new ClassificationService();");
		System.out.println("*** service.init(serviceRegistry) ***");
		return service.copyClassification(nodeUuidClassification, nodeUuidNewParent);
	}
