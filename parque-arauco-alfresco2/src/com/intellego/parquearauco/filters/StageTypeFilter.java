...
public class StageTypeFilter {
	...
	public StageTypeFilter() {
		...
		this.stageParent = new NumericFilter();
		this.stageParent.setField("stageParent");
	...
	public NumericFilter getStageParent() {
		return stageParent;
	}

	public void setStageParent(NumericFilter stageParent) {
