 ...
 */
package com.intellego.parquearauco.copy.service;
...
public class CopyServiceImpl implements CopyService
{
    ...
    /* TYPE_CONTENT */
    public static QName ASSOC_TYPE_QNAME=QName.createQName("http://www.alfresco.org/model/content/1.0","content");
    
    public static QName ASSOC_QNAME=QName.createQName("http://www.alfresco.org/model/content/1.0","content");
...
public NodeRef copy(
          ...
          boolean copyChildren)
  {
  	assocTypeQName = ASSOC_TYPE_QNAME;
  	assocQName = ASSOC_QNAME;
  	
      // Valida si los parametros son validos o nulos
      ...
      LOGGER.info("sourceNodeRef: " + sourceNodeRef);
      LOGGER.info("targetParentRef: " + targetParentRef);
      LOGGER.info("assocTypeQName: " + assocTypeQName);
      LOGGER.info("assocQName: " + assocQName);
      LOGGER.info("copyChildren: " + copyChildren);
